...
geo_pills_population_county_westvirginia %>%
  ...
  geom_sf(lwd = 0) +
  theme_map() +
  labs(fill='Pills per Person',title="Pill shipments increased in 2008,then slowly dissapeared.", subtitle = "Pills per person shipped to West Virginia counties between 2006 to 2012", caption = "Source: ARCOS database") +
...
#this is where I get confused when I filter the initial map, so I was hoping we can discuss planning a call so I can get more information. 
