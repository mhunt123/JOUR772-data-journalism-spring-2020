...
```{r}
#Because the tables have missing values it may mess up your analysis, and producing a accurate statement to a questions without all this missing pieces. 
...
```{r}
# Filter pills population table just for Maryland.  
